% --------------------------------------------------------------------------------
% COMBINED.tex
% AutoRL for Predictive Maintenance (combined manuscript)
% Parent: Article_VSC.tex
% Merged in: AutoRL_for_PdM.tex (Results section preserved)
% Date: 16-Mar-2026
% --------------------------------------------------------------------------------
...
In \texttt{code/rl\_pdm.py}, NW attention is implemented as a learned prototype memory with a strictly-positive bandwidth parameter $\beta=\exp(\log\beta)$:
